  ...
  return (
    <div className="flex items-center md:justify-end md:space-x-6 sm:px-10">
        ...
        <div className="flex lg:space-x-4 items-center">
            <Link href={'/free'}>
                <Button
                className='hidden md:flex text-md font-light rounded-[40px] border-4 border-indigo-400/90 py-6 bg-[#565add] hover:scale-110 transition-all duration-300 shadow-md hover:shadow-indigo-300'>
                    Get Bird for Free
                </Button>
            </Link>
            ...
            <Link href={'/contact'}>
                <Button
                className='hidden text-[#565add] text-md font-light bg-[#eff0ff] rounded-[40px] hover:scale-110 transition-all duration-300 shadow-md md:hidden lg:flex p-6 hover:shadow-indigo-300'>
                    Contact Sales
                </Button>
            </Link>
        </div>
