        ...
        <div className='w-screen h-screen bg-white pt-20 px-4 items-center justify-center absolute top-20 right-0 xl:hidden'>
            <Accordion className='pl-2' type='single' collapsible>
                ...
                <AccordionItem className='my-6 border-b' value='item-2'>
                    <AccordionTrigger className=''>For Business</AccordionTrigger>
                    <AccordionContent>
                        <Link href={"/bird-ai"} className='flex pt-10' onClick={handleLinkClick}>
                            <div>
                        ...
                        <Link href={"/enterprise"} className='flex pt-10' onClick={handleLinkClick}>
                            <div>
                ...
                <AccordionItem className='my-6 border-b' value='item-3'>
                    <AccordionTrigger className=''>Resources</AccordionTrigger>
                    <AccordionContent>
                        <Link href={"/"} className='flex pt-10' onClick={handleLinkClick}>
                            <div>
                        ...
                        <Link href={"/screen-recorder"} className='flex pt-10' onClick={handleLinkClick}>
                            <div>
